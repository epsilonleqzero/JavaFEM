...
#include <armadillo>
#include "RkFehl.h"
#include "net_tedkwan_javafem_nar_DuffingOscil.h"
/*
 ...
 * @return 
 */
JNIEXPORT jdoubleArray JNICALL Java_net_tedkwan_javafem_nar_DuffingOscil_rk4(JNIEnv *env, jobject jobj, jdoubleArray jarray) {
    unsigned int i;
    jboolean isCopy1;
